...
echo "Testing to see that the /var/www/html directory is accessible"
if [[ ! -r "/var/www/html" ]]; then
  echo "HTML directory is not writeable. Check /var/www/html directory setup before continuing."
  exit
fi
